-- Dataset: World
-- Table: world
-- Columns used: name, continent, population, GDP, area, capital
...
-- Question 10:
-- Show the name and per-capita GDP for those countries with a GDP of at least one trillion (1000000000000; that is 12 zeros). Show per-capita GDP for the trillion dollar countries to the nearest $1000.
